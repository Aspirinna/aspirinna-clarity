...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'tabler:brand-github', text: 'GitHub: Aspirinna', url: 'https://github.com/Aspirinna' },
			{ icon: 'ant-design:bilibili-filled', text: 'Bilibili', url: 'https://space.bilibili.com/3494364785412496' },
		...
		nav: [
			...
			},
			{
				title: '社交',
				items: [
					{ icon: 'tabler:brand-github', text: 'Aspirinna', url: 'https://github.com/Aspirinna' },
					{ icon: 'ant-design:bilibili-filled', text: 'Aspirinna', url: 'https://space.bilibili.com/3494364785412496' },
					{ icon: 'tabler:mail', text: blogConfig.author.email, url: `mailto:${blogConfig.author.email}` },
				],
			},
			{
